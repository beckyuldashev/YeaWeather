const SunriseIcon = ({ width = '24px', height = '24px' }) => {
  return (
    <svg
      ...
      />
      <path
        d="M56.625 73.8125L50 67.1875L43.375 73.8125"
        stroke="#FCFC07"
        strokeWidth="3"
        strokeMiterlimit="10"
        strokeLinecap="round"
